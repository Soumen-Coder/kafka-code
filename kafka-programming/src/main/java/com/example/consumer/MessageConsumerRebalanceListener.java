...
public class MessageConsumerRebalanceListener implements ConsumerRebalanceListener {
    ...
    public MessageConsumerRebalanceListener(KafkaConsumer<String, String> consumer) {
